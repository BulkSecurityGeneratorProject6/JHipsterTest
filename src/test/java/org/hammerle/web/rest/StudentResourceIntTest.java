...
import org.hammerle.JhipsterTestApp;

import org.hammerle.domain.Student;
import org.hammerle.repository.StudentRepository;
...
public class StudentResourceIntTest {
    ...
    private static final Long DEFAULT_MARTIKELNUMMER = 1L;
    private static final Long UPDATED_MARTIKELNUMMER = 2L;
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student()
            .martikelnummer(DEFAULT_MARTIKELNUMMER)
    ...
    public void createStudent() throws Exception {
        ...
        assertThat(testStudent.getMartikelnummer()).isEqualTo(DEFAULT_MARTIKELNUMMER);
        ...
        assertThat(testStudent.getHausnummer()).isEqualTo(DEFAULT_HAUSNUMMER);
    ...
    public void getAllStudents() throws Exception {
        ...
        restStudentMockMvc.perform(get("/api/students?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].martikelnummer").value(hasItem(DEFAULT_MARTIKELNUMMER.intValue())))
    ...
    public void getStudent() throws Exception {
        ...
        restStudentMockMvc.perform(get("/api/students/{id}", student.getId()))
            ...
            .andExpect(jsonPath("$.martikelnummer").value(DEFAULT_MARTIKELNUMMER.intValue()))
    ...
    public void updateStudent() throws Exception {
        ...
        updatedStudent
            .martikelnummer(UPDATED_MARTIKELNUMMER)
        ...
        Student testStudent = studentList.get(studentList.size() - 1);
        assertThat(testStudent.getMartikelnummer()).isEqualTo(UPDATED_MARTIKELNUMMER);
        ...
        assertThat(testStudent.getHausnummer()).isEqualTo(UPDATED_HAUSNUMMER);
